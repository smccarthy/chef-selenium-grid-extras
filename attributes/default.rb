...
default[:selenium_grid_extras][:type] = 'node'
...
default[:selenium_grid_extras][:node][:firefox][:selenium_protocol] = 'WebDriver'
default[:selenium_grid_extras][:node][:firefox][:browser_name] = 'firefox'
default[:selenium_grid_extras][:node][:firefox][:max_instances] = '1'
default[:selenium_grid_extras][:node][:firefox][:version] = '37'
default[:selenium_grid_extras][:node][:firefox][:platform] = 'WINDOWS'

default[:selenium_grid_extras][:node][:chrome][:selenium_protocol] = 'WebDriver'
default[:selenium_grid_extras][:node][:chrome][:browser_name] = 'chrome'
default[:selenium_grid_extras][:node][:chrome][:max_instances] = '1'
default[:selenium_grid_extras][:node][:chrome][:version] = '43'
default[:selenium_grid_extras][:node][:chrome][:platform] = 'WINDOWS'

default[:selenium_grid_extras][:node][:ie][:selenium_protocol] = 'WebDriver'
default[:selenium_grid_extras][:node][:ie][:browser_name] = 'internet explorer'
default[:selenium_grid_extras][:node][:ie][:max_instances] = '1'
default[:selenium_grid_extras][:node][:ie][:version] = '11'
default[:selenium_grid_extras][:node][:ie][:platform] = 'WINDOWS'
...
default[:selenium_grid_extras][:default_role] = 'node'
